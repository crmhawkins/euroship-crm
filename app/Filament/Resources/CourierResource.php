...
class CourierResource extends Resource
{
    ...
    public static function getNavigationLabel(): string { return 'Couriers'; }
    public static function getModelLabel(): string { return 'Courier'; }
    public static function getPluralModelLabel(): string { return 'Couriers'; }

    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\TextInput::make('nombre')->required()->maxLength(100)->unique(ignoreRecord: true),
